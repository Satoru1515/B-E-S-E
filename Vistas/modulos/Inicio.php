        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title text-uppercase">Esquema de reporte de ventas mensual</h3>
            ...
            <div class="box-body">
              <div class="row">
                ...
                <div class="col-md-4">
                  <p class="text-center">
                    <strong>OBLIGACIONES DE LA META</strong>
                  </p>

                  <div class="progress-group">
                    <span class="progress-text">Productos agregados al Carro de Compras</span>
                  ...
                  <!-- /.progress-group -->
                  <div class="progress-group">
                    <span class="progress-text">Facturas Generadas</span>
              ...
              <div class="row">
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block border-right">
                    ...
                    <span class="description-text">LOS INGRESOS TOTALES</span>
                  </div>
                  <!-- /.description-block -->
                </div>
                <!-- /.col -->
                ...
                <div class="col-sm-3 col-xs-6">
                  <div class="description-block">
                    ...
                    <span class="description-text">OBLIGACIONES DE LA META</span>
                  </div>
                  <!-- /.description-block -->
                </div>
              </div>
              ...
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    ...
                    <td>10-9-2018</td>
                    <td><span class="label label-success">Generada</span></td>
                    <td>
